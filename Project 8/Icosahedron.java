...
//----------------------------- New Methods ------------------------------
   /**
   *returns count for the static field. 
   *@return count
   */
   public static int getCount() {
    ...
    /**
   *resets the count for the static field. 
   */ 
   public static void resetCount() {
      count = 0;
   }  
   /**
   *returns the equals for the Icosahedron test class.
   *@param obj - used  
   *@return false
   */
   ...
   /**
   *returns the hash code for the icosahedron test. 
   *@return - used
   */
   public int hashCode() {
      return 0;
