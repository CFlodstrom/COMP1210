...
public static findIcosahedronWithShortestEdge() {
   return 
}

public static findIcosahedronWithLongestEdge() {

}

public static findIcosahedronWithSmallestVolume() {

}

public static findIcosahedronWithLargestVolume() {
