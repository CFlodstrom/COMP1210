...
/**************************** New Methods **********************************/
  ...
  */ 
   public IcosahedronList readFile(String fileName) throws FileNotFoundException
   {
      ...
      IcosahedronList newIcosahedronList = new IcosahedronList(
            icosahedronListName, myIcosList);
      return newIcosahedronList;
   }
  /** 
